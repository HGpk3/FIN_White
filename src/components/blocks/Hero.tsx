...
export function Hero() {
  return (
    <section id="hero" className="border-b border-[var(--color-border)] bg-[var(--color-surface-strong)]/60 py-14 sm:py-20">
      <Container className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="space-y-6">
          <div className="inline-flex items-center gap-2 rounded-full border border-[var(--color-border)] bg-[var(--color-surface)] px-3 py-1 text-xs uppercase tracking-[0.18em] text-[var(--color-muted)]">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div className="flex items-center gap-3 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] p-4 text-sm text-[var(--color-muted)]">
        ...
        <div className="rounded-2xl border border-[var(--color-border)] bg-gradient-to-br from-white/5 via-[var(--color-surface)] to-black/60 p-8 shadow-2xl shadow-black/40">
